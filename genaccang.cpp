// genaccang.cpp
//
// generate angluar acceptance (cos(theta),phi)
//
// g++ -Wall genaccang.cpp xyunitgeom.cpp setup1f1.cpp hist2d.cpp -o genaccang.exe
//
...
int main (int argc, char* argv[])
{
	...
	{
		Hist2D ("Infinite uniform", , , 199, -99.5, 99.5, 199),
