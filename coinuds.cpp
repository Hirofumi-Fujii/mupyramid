// coinuds.cpp
// g++ -Wall coinuds.cpp coinrecord.cpp hist1d.cpp hist2d.cpp gzfstream.cpp gzipfilebuf.cpp  ncpng.cpp mytimer.cpp -lz -o coinuds
...
char outfnam[] = "coinuds_detx_x.xxx";
...
int main (int argc, char* argv[])
{
	...
	{
		mylibrary::Hist2D ("dxdy-U", -99.5, 99.5, 199, -99.5, 99.5, 199),
		mylibrary::Hist2D ("dxdy-U-smooth", -99.5, 99.5, 199, -99.5, 99.5, 199, true),
		mylibrary::Hist2D ("dxdy-D", -99.5, 99.5, 199, -99.5, 99.5, 199),
		mylibrary::Hist2D ("dxdy-D-smooth", -99.5, 99.5, 199, -99.5, 99.5, 199, true),
	};

	static const int NUMHIST1D = 2;
	mylibrary::Hist1D hist1d[NUMHIST1D] =
	{
		mylibrary::Hist1D("tof-U", -99.5, 99.5, 199),
		mylibrary::Hist1D("tof-D", -99.5, 99.5, 199),
	};
				...
				while (getline (ifs, recstr))
				{
						...
						(recstr.substr(0,4) == "COIN"))
					{
						...
						if (histit)
						{
							...
							if (tofok)
							{
								hist2d[iud * 2 + 0].cumulate (dx, dy);
								hist2d[iud * 2 + 1].cumulate (dx, dy);
