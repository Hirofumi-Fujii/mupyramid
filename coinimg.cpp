// coinimg.cpp
// g++ -Wall coinimg.cpp coinrecord.cpp hist1d.cpp hist2d.cpp gzfstream.cpp gzipfilebuf.cpp  ncpng.cpp mytimer.cpp -lz -o coinimg.exe
...
char outfnam[] = "coinimg_detx_x.xxx";
...
int main (int argc, char* argv[])
{
	...
	mylibrary::Hist2D hist2d[NUMHIST2D] =
	{
		...
		mylibrary::Hist2D ("UFdxdy", -0.5, 99.5, 100, -0.5, 99.5, 100, true),
		mylibrary::Hist2D ("URdxdy", -0.5, 99.5, 100, -0.5, 99.5, 100, true),
	};

	mylibrary::Hist1D histtof("tof", -99.5, 99.5, 199);
